...
namespace WebAppServer.Repositories
{
    public class UsuarioAcessoRepository
    {
            ...
            using (SqlConnection conn = new SqlConnection(configDB.ConnectString))
            {
                ...
                using (SqlTransaction tran = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        str_ret = repData.ConsultaGenerica("[{ \"nome\":\"ID\", \"valor\":\"" + id_prim.ToString() + "\", \"tipo\":\"Int64\"},{ \"nome\":\"Email\", \"valor\":\"\", \"tipo\":\"string\"},{ \"nome\":\"CodAcesso\", \"valor\":\"0\", \"tipo\":\"Int64\"},{ \"nome\":\"situacao\", \"valor\":\"0\", \"tipo\":\"Int16\"}]", "ntv_p_sel_tbl_prim_acess", conn, tran);
        ...
        public async Task<bool> ValPrimeiroAcesso(string str_mail, Int64 codigo)
        {
            ...
            {                
                conn.Open();
                str_ret = repData.ConsultaGenerica("[{ \"nome\":\"ID\", \"valor\":\"0\", \"tipo\":\"Int64\"},{ \"nome\":\"Email\", \"valor\":\"" + str_mail + "\", \"tipo\":\"string\"},{ \"nome\":\"CodAcesso\", \"valor\":\"" + codigo.ToString() + "\", \"tipo\":\"Int64\"},{ \"nome\":\"situacao\", \"valor\":\"0\", \"tipo\":\"Int16\"}]", "ntv_p_sel_tbl_prim_acess", conn);
                primAcesses = JsonConvert.DeserializeObject<List<UserPrimAcess>>(str_ret);
