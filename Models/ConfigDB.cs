...
namespace WebAppServer.Models
{
    public class ConfigDB
    {
        ...
        public ConfigDB()
        {
            ...
            //_strConnect = obj_config["ConnectionStrings"]["DeafultConnectionStrings"].ToString() + "JjmlS2024$";
            //_strConnect = obj_config["ConnectionStrings1"]["DeafultConnectionStrings"].ToString() + "natividade";
            _strConnect = obj_config["ConnectionStrings1"]["DeafultConnectionStrings"].ToString();
        }
